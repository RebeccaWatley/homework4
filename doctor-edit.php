...
?>
<form method="post" action="doctor-edit-save.php">
  <div class="mb-3">
    <label for="DoctorName" class="form-label">Name</label>
    <input type="text" class="form-control" id="DoctorName" aria-describedby="nameHelp" name="dName" value="<?=$row['DoctorName']?>">
